...
userFromJson(User data, Map<String, dynamic> json) {
  ...
  if (json['patients'] != null) {
    data.patients =
        json['patients']?.map((v) => v?.toString())?.toList()?.cast<String>();
  }
  if (json['notify_patients_when_free'] != null) {
    data.notifyPatientsWhenFree = json['notify_patients_when_free']
        ?.map((v) => v?.toString())
        ?.toList()
        ?.cast<String>();
  }
  ...
  if (json['roles'] != null) {
    data.roles =
        json['roles']?.map((v) => v?.toString())?.toList()?.cast<String>();
  }
  if (json['mobile'] != null) {
  ...
  if (json['invites'] != null) {
    data.invites =
        json['invites']?.map((v) => v?.toString())?.toList()?.cast<String>();
  }
...
userDocumentsFromJson(UserDocuments data, Map<String, dynamic> json) {
  if (json['files'] != null) {
    data.files =
        json['files']?.map((v) => v?.toString())?.toList()?.cast<String>();
  }
  if (json['name'] != null) {
